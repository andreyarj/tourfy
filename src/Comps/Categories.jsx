...
const Categories = () => {
    return (
        <>
        <section id='categories' className='flex flex-row flex-wrap items-start justify-start gap-[20px] w-full h-auto px-[20px] t:px-[40px] py-[40px] bg-white dark:bg-slate-dark'>
