    ...
    return (
        ...
        <section id="Welcome" className='w-full h-auto bg-white dark:bg-slate-dark'>
            ...
            <div className={`flex flex-col flex-nowrap items-start justify-center gap-[15px] w-full t:max-w-[650px] h-auto mx-auto px-[20px] py-[30px] bg-[url('${Everest}')] bg-cover bg-center`}>
                ...
                <button type="submit" className='w-[120px] h-[40px] bg-white/10 dark:bg-slate/20 dark:hover:bg-slate/30 hover:bg-white/30 font-Syne font-[900] text-white dark:text-slate-dark backdrop-blur-[3px] hover:backdrop-blur-[5px] shadow-xl hover:shadow-2xl rounded-[10px] transition .3s'>Viajar</button>
